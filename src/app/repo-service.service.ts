...
export class RepoServiceService {
  ...
  topics: any[]=[{name: "Javascript", data: []}, {name: "Java", data: []}, {name: "Python", data: []}];  
  ...
  getTopRepos(type, topic, per_page){ 
   return this.http.get(`https://api.github.com/search/repositories?s=`+type+`&q=`+topic+`&per_page=`+per_page);
  }  
